...
export default function EmailVerificationPage() {
  ...
  const { verifyBusiness, isLoading, error } = useBusinessStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await verifyBusiness(verificationCode);
      navigate("/user-login");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center w-full">
      <motion.div
        ...
        className="bg-blue-950 bg-opacity-90 backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full max-w-md overflow-hidden my-10"
      >
